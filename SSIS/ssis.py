...
def retrieve_data():
    ...
    list_data = []
    file_path = "D:/Downloads/SSIS/students.txt"
    try:
...
def open_program():
    program_path = "D:/Downloads/SSIS/courses.py"
    try:
...
gpa_label = customtkinter.CTkLabel(root, text="Gender: ")
gpa_label.grid(row=2, column=2, padx=20, pady=20)
gpa_entry = customtkinter.CTkComboBox(root, values=["Male", "Female"], state="readonly")
...
student_list.heading("gpa", text="Gender")
