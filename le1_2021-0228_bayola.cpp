...
public:
    ...
    {
        DLink<E> *iLink = new DLink<E>;
        assert(iLink != nullptr);

        iLink->theElement = it;
        iLink->prevPtr = tail->prevPtr;
        iLink->nextPtr = tail;

        tail->prevPtr->nextPtr = iLink;
        tail->prevPtr = iLink;
    ...
    {
        DLink<E> *nLink = new DLink<E>;
        assert(nLink != nullptr);

        nLink->theElement = it;
        nLink->prevPtr = tail->prevPtr;
        nLink->nextPtr = tail;

        tail->prevPtr->nextPtr = nLink;
        tail->prevPtr = nLink;
